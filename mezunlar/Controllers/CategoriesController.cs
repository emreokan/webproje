...
namespace mezunlar.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,KategoriAdi,Image")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,KategoriAdi,Image")] Category category)
        {
            if (ModelState.IsValid)
            {
